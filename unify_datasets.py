...
def process_folder(input_path, output_base, dataset_name, dataset_type, unified_dir, file_prefix=""):
    ...
    Args:
        ...
        output_base: Base path for output (individual dataset processing)
        dataset_name: Name of the dataset
        dataset_type: Type of data (train, val, test)
        unified_dir: Directory for unified dataset
        file_prefix: Prefix to add to filenames to avoid conflicts
    """
...
def main():
    ...
    parser.add_argument('--unified_dir', type=str, default='D:/projectfolders/ParkAI/unified_dataset',
