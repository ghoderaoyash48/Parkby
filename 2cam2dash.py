...
def main():
    ...
    MAX_PARKING_SPACES_1 = 150
    MAX_PARKING_SPACES_2 = 150
    ...
    # Data for dashboard - Camera 1
    dashboard_update_interval = 20  # Update dashboard every 20 seconds
    last_dashboard_update_1 = time.time()
    current_vehicle_count_1 = 0
    current_available_spaces_1 = MAX_PARKING_SPACES_1
    parking_percentage_1 = 0
   
    # Data for dashboard - Camera 2
    last_dashboard_update_2 = time.time()
    current_vehicle_count_2 = 0
    current_available_spaces_2 = MAX_PARKING_SPACES_2
    parking_percentage_2 = 0
   
    # Function to create dashboard
    def create_dashboard(width, height, status, available_slots, percentage_filled, date_str, camera_name):
        ...
        cv2.putText(dashboard, f"IT PARKING - {camera_name}", (width//4, header_height-15),
